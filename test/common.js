...
module.exports.deployDAOFactory = async (test) => { 
...
module.exports.deployDAO = async (test, daoManager) => {
...
module.exports.deployApp = async (test, appManager) => {
...
module.exports.deployTokens = async (test) => {
  test.voteToken = await MiniMeToken.new(ZERO_ADDRESS, ZERO_ADDRESS, 0, 'VoteToken', 18, 'ANT', false);
  test.stakeToken = await MiniMeToken.new(ZERO_ADDRESS, ZERO_ADDRESS, 0, 'StakeToken', 18, 'GEN', true);
};
